      ...
      <div className="max-w-md mx-auto w-full px-6">
        ...
        {hasSubs && (
          <div className="bg-primary text-white rounded-2xl p-4 mb-3 shadow-sm">
            ...
            <p className="text-xs opacity-90">{subscriptions.length} active {subscriptions.length === 1 ? 'subscription' : 'subscriptions'}</p>
          </div>
        )}
        ...
        {hasSubs && view === 'calendar' && <CalendarView subscriptions={subscriptions} />}
      </div>
